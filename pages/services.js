        ...
        <div className="container-fluid px-lg-5 mt-5 bg-light py-5" style={{marginTop:'100px !important'}}>
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-globe text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-shopping-cart text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-desktop text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-money text-dark fa-2x" /></h2>
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-cogs text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-bullseye text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-google text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-database text-dark fa-2x" /></h2>
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-comments text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-mobile text-dark fa-2x" /></h2>
              <h4 className="text-center"> App Development</h4>
              <p className="text-justify">Transform your business ideas into mobile applications with Web Finder. Mobile application development arena being one of the most innovative spaces in the industry today holds the prospect for the future of business. We make mobile apps for multiple-platforms like Android, iOS and cross-platform solutions in Xamarin, PhoneGap, etc. Our mobile app development team has a long streak in releasing foolproof, quality applications in the Google Playstore and iOS app stores.</p>
            </div></div>
            {/*-------- box end -----------*/}
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-bar-chart text-dark fa-2x" /></h2>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12 mb-5">
              <div className="shadow inner-service px-3 py-4">
              <h2 className="text-center"><i className="fa fa-laptop text-dark fa-2x" /></h2>
